...
const SideBar = () => {
  return (
    <div className='bg-[#003A10] min-h-screen pl-[4vw]'>
      <img className='mt-5 w-[max(10vw,100px)] hidden sm:block' src={assets.logo} alt='logo' />
      <img className='mt-5 w-[max(5vw,40px)] mr-5 sm:hidden block' src={assets.logo_small} alt='logo-small' />
